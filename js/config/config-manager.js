...
function getSavedConfigString() {
  let tmpCM = {};
  for (let key in configManager) {
    if (
      !getSystemParameters().includes(key) ||
      getSavedSystemParameters().includes(key)
    ) {
      tmpCM[key] = configManager[key];
    }
  }
  return JSON.stringify(tmpCM);
}

function saveCM() {
  let tmpCMString = getSavedConfigString();
  setSavedConfig(tmpCMString);
  ...
  return {
    GENERAL: [
      ...
      },
      {
        ...
        describe:
          "The moving length of breathing effect, default as 1. Range(0, 10)",
        range: [0, 10],
      },
      {
        key: "MOOD_AUTO_RATIO",
        ...
        describe:
          "The dramatic-degree of the auto-mood detection, default as 2. Range(0, 10)",
        range: [0, 10],
      },
      {
        ...
        describe:
          "Auto-mood works when the value is larger than the offset, default as 0.1. Range(0, 1)",
        range: [0, 1],
      },
      {
        key: "3D_FPS_LIMIT",
        title: "3D_FPS Limit",
        describe:
          "The FPS limit for 3D rendering visualization, default as 120. Range(1, 120)",
        range: [1, 120],
      },
      {
        key: "ML_FPS_LIMIT",
        title: "ML_FPS Limit",
        describe:
          "The FPS limit for ML computation, default as 120. Range(1, 120)",
        range: [1, 120],
      },
      {
        key: "MULTI_THREAD",
    ...
    SHADING: [
      {
        key: "ENABLE_RIMLIGHT",
        title: "Rimlight",
        describe: "Enable or disable rim lighting effect.",
        valid: [true, false],
      },
    ],
    SMOOTH: [
      {
        ...
        describe:
          "The higher this value is, the more overall sensitive it is to human movement, default as 1. Range(0.1, 3).",
        range: [0.1, 3],
      },
      {
        ...
        describe:
          "The higher this value is, the smoother the body motion is, default as 1.5. Range(0, 10).",
        range: [0, 10],
      },
      {
        key: "MOMENTUM_RATIO",
    ...
    BODY: [
      {
        ...
        describe:
          "The multiplication parameter to rotate the head as the head rotation. Range(-2, 2)",
        range: [-2, 2],
      },
      {
        key: "NECK_RATIO",
        ...
        describe:
          "The multiplication parameter to rotate the neck as the head rotation. Range(-2, 2)",
        range: [-2, 2],
      },
      {
        key: "CHEST_RATIO",
        ...
        describe:
          "The multiplication parameter to rotate the chest as the head rotation. Range(-2, 2)",
        range: [-2, 2],
      },
      {
    ...
    MOUTH: [
      {
        ...
        describe:
          "Mouth will only open after the openness value is larger than the offset. Range(0, 1)",
        range: [0, 1],
      },
      {
        key: "MOUTH_RATIO",
    ...
    BROWS: [
      {
        ...
        describe:
          "Brows will only open after the openness value is larger than the offset. Range(0, 1)",
        range: [0, 1],
      },
      {
        key: "BROWS_RATIO",
        ...
        describe:
          "The multiplication parameter for brows openness. Range(0, 20)",
        range: [0, 20],
      },
      {
    ...
    HAND: [
      ...
      },
      {
        ...
        describe:
          "Control the grip ratio of fingers. Default to 1. Range(0, 5)",
        range: [0, 5],
      },
      {
        ...
        describe:
          "Control the spread ratio of fingers. Default to 1. Range(0, 5)",
        range: [0, 5],
      },
    ],
    POSITION: [
      ...
      },
      {
        ...
        describe:
          "The larger the number is, the faster the VRM model move horizontally. Range(-1, 1)",
        range: [-1, 1],
      },
      {
        ...
        describe:
          "The larger the number is, the faster the VRM model move vertically. Range(-1, 1)",
        range: [-1, 1],
      },
      {
        ...
        describe:
          "The larger the number is, the faster the VRM model move forward and backward. Range(-1, 1)",
        range: [-1, 1],
      },
    ],
    UI: [
